...
const Navbar = ({auth: {isAuthenticated, loading}, logout}) => {
  ...
  return (
    ...
    <Button
        ...
        color="primary"
        className="Navbutton"
        startIcon={<AccountBalanceWalletIcon />} // Use a relevant icon
    >
        Wallet
    </Button>
</Link>
<Link to="/subscription">
    <Button
        ...
        color="primary"
        className="Navbutton"
        startIcon={<SubscriptionsIcon />} // Use a relevant icon
    >
        Subscription
    </Button>
</Link>
    ...
    <Link to="/wallet">
        <StyledMenuItem>
            ...
            <ListItemText className="Navbuttondrop" primary="Wallet" />
        </StyledMenuItem>
    </Link>
    <Link to="/subscription">
        <StyledMenuItem>
            ...
            <ListItemText className="Navbuttondrop" primary="Subscription" />
        </StyledMenuItem>
    </Link>
</List>
